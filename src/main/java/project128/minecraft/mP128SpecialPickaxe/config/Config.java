...
public class Config {
    ...
    public SpecialPickaxe getPickaxe(@NotNull String name) {
        ...
        SpecialPickaxe.Shape shape = new SpecialPickaxe.Shape(
                SpecialPickaxe.ShapeType.RECTANGLE,
                0,
                getField(new String[]{"pickaxes", name, "shape", "width"}, Integer.class),
                getField(new String[]{"pickaxes", name, "shape", "height"}, Integer.class),
                getField(new String[]{"pickaxes", name, "shape", "length"}, Integer.class)
        );
